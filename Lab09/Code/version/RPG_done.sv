...
// always_comb begin
//     case (A[0]) 
//         player_data.MP      : min1 = 2'd0 ;
//         player_data.HP      : min1 = 2'd1 ;
//         player_data.Attack  : min1 = 2'd2 ;
//         player_data.Defense : min1 = 2'd3 ; 
//         default             : min1 = 2'd0 ;
//     endcase
// end
...
// always_comb begin
//     case (A[1]) 
//         player_data.MP      : min2 = 2'd0 ;
//         player_data.HP      : min2 = 2'd1 ;
//         player_data.Attack  : min2 = 2'd2 ;
//         player_data.Defense : min2 = 2'd3 ; 
//         default             : min2 = 2'd0 ;
//     endcase
// end
...
always_comb begin
    case(1)
        (!player_HP_temp[16]) && (monster_HP_temp[16]) : battle_Result = WIN ;
...
//     else if((active_state_reg==battle_active)) begin
//         case(battle_Result)
...
//     else if (active_state_reg==levelup_active)  exp_new <= player_data.Exp ;
...
// Skill
//=============================================
assign mp_flag = (player_data.MP < mp_skill[0]) && 
                 (player_data.MP < mp_skill[1]) &&
                 (player_data.MP < mp_skill[2]) &&
                 (player_data.MP < mp_skill[3]) ;
