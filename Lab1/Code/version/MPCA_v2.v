...
Mask maskpack0 (
    .priority_score({packet_before_sorting[0][4:3],1'b0}),
...
Mask maskpack1 (
    .priority_score({packet_before_sorting[1][4:3],1'b0}),
...
Mask maskpack2 (
    .priority_score({packet_before_sorting[2][4:3],1'b0}),
...
Mask maskpack3 (
    .priority_score({packet_before_sorting[3][4:3],1'b0}),
...
Mask maskpack4 (
    .priority_score({packet_before_sorting[4][4:3],1'b0}),
...
Mask maskpack5 (
    .priority_score({packet_before_sorting[5][4:3],1'b0}),
...
Mask maskpack6 (
    .priority_score({packet_before_sorting[6][4:3],1'b0}),
...
Mask maskpack7 (
    .priority_score({packet_before_sorting[7][4:3],1'b0}),
...
//v2 let make channel[ch] ch is allocation ch 
// cycle time =35.5 
// Total cell area:                204344.079374
// Total area:                    1017468.153318