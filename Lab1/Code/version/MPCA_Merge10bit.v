...
wire signed [10:0] packet_after_sorting[0:7]; //maybe
wire signed [10:0] packet_before_sorting[0:7];//maybe
...
assign packet_after_sorting[0] = {priority_score[0] ,3'd0 };
assign packet_after_sorting[1] = {priority_score[1] ,3'd1 };
assign packet_after_sorting[2] = {priority_score[2] ,3'd2 };
assign packet_after_sorting[3] = {priority_score[3] ,3'd3 };
assign packet_after_sorting[4] = {priority_score[4] ,3'd4 };
assign packet_after_sorting[5] = {priority_score[5] ,3'd5 };
assign packet_after_sorting[6] = {priority_score[6] ,3'd6 };
assign packet_after_sorting[7] = {priority_score[7] ,3'd7 };
...
assign packetnum[0] = packet_before_sorting[0][2:0];
assign packetnum[1] = packet_before_sorting[1][2:0];
assign packetnum[2] = packet_before_sorting[2][2:0];
assign packetnum[3] = packet_before_sorting[3][2:0];
assign packetnum[4] = packet_before_sorting[4][2:0];
assign packetnum[5] = packet_before_sorting[5][2:0];
assign packetnum[6] = packet_before_sorting[6][2:0];
assign packetnum[7] = packet_before_sorting[7][2:0];
...
Packet_allocator alloc0 (
    .packet_in({req_valid[packetnum[0]],prefer_ch[packetnum[0]]}),
...
Packet_allocator alloc1 (
    .packet_in({req_valid[packetnum[1]],prefer_ch[packetnum[1]]}),
...
Packet_allocator alloc2 (
    .packet_in({req_valid[packetnum[2]],prefer_ch[packetnum[2]]}),
...
Packet_allocator alloc3 (
    .packet_in({req_valid[packetnum[3]],prefer_ch[packetnum[3]]}),
...
Packet_allocator alloc4 (
    .packet_in({req_valid[packetnum[4]],prefer_ch[packetnum[4]]}),
...
Packet_allocator alloc5 (
    .packet_in({req_valid[packetnum[5]],prefer_ch[packetnum[5]]}),
...
Packet_allocator alloc6 (
    .packet_in({req_valid[packetnum[6]],prefer_ch[packetnum[6]]}),
...
Packet_allocator alloc7 (
    .packet_in({req_valid[packetnum[7]],prefer_ch[packetnum[7]]}),
...
always @(*) begin //maybe pkt_len lut
    if(mode) begin
        case(pkt_len)
...
module Packet_allocator (
    // Input: packet
    input  [2:0] packet_in,        // [9:3]=priority, [2]=req_valid, [1:0]=prefer_ch
...
module compare2 (
    ...
    output reg signed [10:0] out1,out2
);
...
module MergeSort_4 (
    ...
    output wire signed [10:0] out1,out2,out3,out4
);
wire signed [10:0]c1,c2,c3,c4,c5,c6;
...
module MergeSort_8 (
    input signed [10:0] in1,in2,in3,in4,in5,in6,in7,in8,
    output wire signed [10:0] out1,out2,out3,out4,out5,out6,out7,out8
);
wire signed [10:0]c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12;
...
//================================================================
//MPCA_Merge10bit : reduce merge sort from 13 bits to 10bits (NOT GOOD)
// cycle time =33.5
// Total area:                    1088124.566311
// Total cell area:                228566.924252
