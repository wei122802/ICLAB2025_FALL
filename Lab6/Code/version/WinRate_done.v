...
//             for(j = 0 ; j < 4 ; j = j + 1)
//                 _31_card[i][j] <= 1'b0;
//     else if(state_c == INPUT) begin
//         //public
//         _31_card[in_pub_num_reg[11:8]] [in_pub_suit_reg[5:4]] <=1'b1;
//         _31_card[in_pub_num_reg[7:4]]  [in_pub_suit_reg[3:2]] <=1'b1;
//         _31_card[in_pub_num_reg[3:0]]  [in_pub_suit_reg[1:0]] <=1'b1;
//         // hole
//         _31_card[in_hole_num_reg[71:68]][in_hole_suit_reg[35:34]] <=1'b1;
//         _31_card[in_hole_num_reg[67:64]][in_hole_suit_reg[33:32]] <=1'b1;
//         _31_card[in_hole_num_reg[63:60]][in_hole_suit_reg[31:30]] <=1'b1;
//         _31_card[in_hole_num_reg[59:56]][in_hole_suit_reg[29:28]] <=1'b1;
//         _31_card[in_hole_num_reg[55:52]][in_hole_suit_reg[27:26]] <=1'b1;
//         _31_card[in_hole_num_reg[51:48]][in_hole_suit_reg[25:24]] <=1'b1;
//         _31_card[in_hole_num_reg[47:44]][in_hole_suit_reg[23:22]] <=1'b1;
//         _31_card[in_hole_num_reg[43:40]][in_hole_suit_reg[21:20]] <=1'b1;
//         _31_card[in_hole_num_reg[39:36]][in_hole_suit_reg[19:18]] <=1'b1;
//         _31_card[in_hole_num_reg[35:32]][in_hole_suit_reg[17:16]] <=1'b1;
//         _31_card[in_hole_num_reg[31:28]][in_hole_suit_reg[15:14]] <=1'b1;
//         _31_card[in_hole_num_reg[27:24]][in_hole_suit_reg[13:12]] <=1'b1;
//         _31_card[in_hole_num_reg[23:20]][in_hole_suit_reg[11:10]] <=1'b1;
//         _31_card[in_hole_num_reg[19:16]][in_hole_suit_reg[9:8]]   <=1'b1;
//         _31_card[in_hole_num_reg[15:12]][in_hole_suit_reg[7:6]]   <=1'b1;
//         _31_card[in_hole_num_reg[11:8]] [in_hole_suit_reg[5:4]]   <=1'b1;
//         _31_card[in_hole_num_reg[7:4]]  [in_hole_suit_reg[3:2]]   <=1'b1;
//         _31_card[in_hole_num_reg[3:0]]  [in_hole_suit_reg[1:0]]   <=1'b1;    
//     end
//     else
//         for(i = 2 ; i<=A ; i = i+1)
//             for(j = 0 ; j < 4 ; j = j + 1)
//                 _31_card[i][j] <= _31_card[i][j] ;
// end
...
//     .IN_PUB_CARD_NUM(in_pub_num_reg),
//     .IN_PUB_CARD_SUIT(in_pub_suit_reg),
//     .OUT_WINNER (out_win_rate)
// );
...
assign player_win_rate[0] = (cnt ==518 ) ? (player_score[0]*100 ) /16740 : 0;
assign player_win_rate[1] = (cnt ==518 ) ? (player_score[1]*100 ) /16740 : 0;
assign player_win_rate[2] = (cnt ==518 ) ? (player_score[2]*100 ) /16740 : 0;
assign player_win_rate[3] = (cnt ==518 ) ? (player_score[3]*100 ) /16740 : 0;
assign player_win_rate[4] = (cnt ==518 ) ? (player_score[4]*100 ) /16740 : 0;
assign player_win_rate[5] = (cnt ==518 ) ? (player_score[5]*100 ) /16740 : 0;
assign player_win_rate[6] = (cnt ==518 ) ? (player_score[6]*100 ) /16740 : 0;
assign player_win_rate[7] = (cnt ==518 ) ? (player_score[7]*100 ) /16740 : 0;
assign player_win_rate[8] = (cnt ==518 ) ? (player_score[8]*100 ) /16740 : 0;

always @(*) begin
    if(state_c == IDLE) begin
        out_win_rate_comb = 63'b0;
    // end else if(state_c == OUTPUT) begin
