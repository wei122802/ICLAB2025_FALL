...
# Created by write_sdc on Sat Dec 20 16:58:48 2025
...
set_input_delay -clock clk  -max 5.55  [get_ports in_valid]
set_input_delay -clock clk  -min 0  [get_ports in_valid]
set_input_delay -clock clk  -max 5.55  [get_ports in_valid2]
...
set_output_delay -clock clk  -max 5.55  [get_ports out_sad]
